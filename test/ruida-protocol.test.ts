...
describe('Ruida Protocol Compliance', () => {
    ...
    describe('Command Format Validation', () => {
        ...
        test('should validate movement commands', () => {
            ...
            const moveCmd = Buffer.from([0x88, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00]);
            const cutCmd = Buffer.from([0xA8, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00]);
