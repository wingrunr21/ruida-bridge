                ...
                if (packetLen > 0 && packet.length >= packetLen) {
                    ...
                    switch (packetType) {
                        case PacketType.Laser:
                            ...
                            outSocket.send(packetData, this.config.toLaserPort, this.config.laserIp);
                        ...
                        default:
                            this.status.error(`Unhandled packet type: 0x${packetType.toString(16)}`);
                    }
                }
            };
